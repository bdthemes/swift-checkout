...
$cartButtonAlignment = !empty($args['cartButtonAlignment']) ? $args['cartButtonAlignment'] : 'button-left';
// Get the product
...
<div class="swift-checkout-container <?php echo esc_attr($preset); ?>" data-builder=" gutenberg">
    <div class="swift-checkout-product-card <?php echo esc_attr($cartButtonAlignment); ?>" data-product-id="<?php echo esc_attr($product->get_id()); ?>">
